| Paper | **Foundational Principles** | Immersion | Motion | Stereo | Overview+Detail | Navigation | Clutter | Guidance | Collaboration | Usability | **Modalities** | Multi-sensory | LLM | **Evaluation** | Eval |
|-------|------------------------------|-----------|--------|--------|-----------------|------------|---------|----------|---------------|-----------|----------------|---------------|-----|----------------|------|
